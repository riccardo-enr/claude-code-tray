...
- [x] **TUI-09**: The live sessions table is styled — status-colored rows and improved spacing/borders/striping — over the current plain DataTable.
- [x] **TUI-10**: Each panel (usage, trends, sessions) is wrapped in a titled, rounded bordered box, giving the btop-style paneled layout.
