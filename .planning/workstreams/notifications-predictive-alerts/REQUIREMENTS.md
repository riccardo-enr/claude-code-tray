...
- [x] **SOCK-02**: The query path shares the socket without disrupting the existing fire-and-forget hook-event path — a stalled or malformed query connection cannot block or corrupt a session-event write.
