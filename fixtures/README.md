...
| `cum_trend_axis` | `{"ticks": ["..."]}` -- y-axis ticks autoscaled to the cum_trend series' own observed peak, or "absent"; same {top, middle, floor} shape as `trend_axis` -- no longer a fixed ceiling |
